...
class YaDiskBackup:
    ...
    1. Recursively walking through the 'target_directory' and adding a random digit to the file extension
    ...
    rename_files()
        Recursively walking through the 'target_directory' and adding a random digit to the file extension
